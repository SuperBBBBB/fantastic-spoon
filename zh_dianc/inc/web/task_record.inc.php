...
if ($operation == 'display') {
    ...
    $list = pdo_fetchall("SELECT * FROM " . tablename($this->table) . " WHERE weid = :weid AND from_user<>'' {$condition} ORDER BY id DESC " . $limit, array(':weid' => $weid));
...
include $this->template('web/task_record');